...
/* ── 34: CLASSIC FULL (1) ───────────────────────────────────
   Clean full-page single photo with subtle border */
const T34 = t('t34', 'Classic Full', 'single', [
  s(5, 5, 90, 90),
]);

/* ── 35: CLASSIC DUO (2) ────────────────────────────────────
   Clean vertical split, two equal columns */
const T35 = t('t35', 'Classic Duo', 'duo', [
  s(5, 5, 43, 90),
  s(52, 5, 43, 90),
]);
...
const T36 = t('t36', 'Classic L', 'mixed', [
  s(5, 5, 30, 90),
  s(40, 5, 55, 42),
  s(40, 53, 55, 42),
]);

/* ── 37: CLASSIC REVERSE L (3) ──────────────────────────────
   Two stacked left + tall hero right */
const T37 = t('t37', 'Classic Reverse L', 'mixed', [
  s(5, 5, 55, 42),
  s(5, 53, 55, 42),
  s(63, 5, 32, 90),
]);

/* ── 38: CLASSIC TRIPLET (3) ────────────────────────────────
   Three equal columns */
const T38 = t('t38', 'Classic Triplet', 'strip', [
  s(3, 5, 30, 90),
  s(35, 5, 30, 90),
  s(67, 5, 30, 90),
]);

/* ── 39: CLASSIC HERO TOP (3) ───────────────────────────────
   Wide hero top + two equal bottom */
const T39 = t('t39', 'Classic Hero Top', 'hero', [
  s(5, 5, 90, 45),
  s(5, 55, 43, 40),
  s(52, 55, 43, 40),
]);

/* ── 40: CLASSIC HERO BOTTOM (3) ────────────────────────────
   Two equal top + wide hero bottom */
const T40 = t('t40', 'Classic Hero Bottom', 'hero', [
  s(5, 5, 43, 42),
  s(52, 5, 43, 42),
  s(5, 52, 90, 43),
]);

/* ── 41: CLASSIC COLUMNS (3) ────────────────────────────────
   Left portrait + center tall + right portrait */
const T41 = t('t41', 'Classic Columns', 'strip', [
  s(5, 15, 28, 70),
  s(36, 5, 28, 90),
  s(67, 15, 28, 70),
]);

/* ── 42: CLASSIC ASYMMETRIC (3) ─────────────────────────────
   Large hero left + two stacked right */
const T42 = t('t42', 'Classic Asymmetric', 'hero', [
  s(5, 5, 55, 90),
  s(63, 5, 32, 42),
  s(63, 53, 32, 42),
]);

/* ── 43: CLASSIC GRID 2x2 (4) ───────────────────────────────
   Clean four-square grid */
const T43 = t('t43', 'Classic Grid 2x2', 'grid', [
  s(5, 5, 43, 42),
  s(52, 5, 43, 42),
  s(5, 52, 43, 43),
  s(52, 52, 43, 43),
...
/* ── 44: CLASSIC HERO + 3 (4) ───────────────────────────────
   Tall hero left + three stacked right */
const T44 = t('t44', 'Classic Hero Trio', 'hero', [
  s(5, 5, 48, 90),
  s(55, 5, 40, 26),
  s(55, 34, 40, 26),
  s(55, 63, 40, 32),
...
/* ── 45: CLASSIC STRIPS (4) ─────────────────────────────────
   Four equal horizontal strips */
const T45 = t('t45', 'Classic Strips', 'strip', [
  s(5, 5, 90, 20),
  s(5, 28, 90, 20),
  s(5, 51, 90, 20),
  s(5, 74, 90, 20),
...
/* ── 46: CLASSIC QUAD (4) ───────────────────────────────────
   One left tall + three stacked right */
const T46 = t('t46', 'Classic Quad', 'mixed', [
  s(5, 5, 35, 90),
  s(43, 5, 52, 26),
  s(43, 34, 52, 26),
  s(43, 63, 52, 32),
...
/* ── 47: CLASSIC FIVE (5) ───────────────────────────────────
   Hero left + four stacked right (2x2) */
const T47 = t('t47', 'Classic Five', 'hero', [
  s(5, 5, 48, 90),
  s(55, 5, 40, 42),
  s(55, 5, 40, 42),
  s(55, 50, 40, 22),
...
/* ── 48: CLASSIC FIVE ALT (5) ───────────────────────────────
   2 left + 3 right */
const T48 = t('t48', 'Classic Five Alt', 'mixed', [
  s(5, 5, 28, 42),
  s(5, 52, 28, 43),
  s(36, 5, 28, 42),
  s(67, 5, 28, 42),
...
/* ── 49: CLASSIC FIVE HERO (5) ──────────────────────────────
   Hero top + 2x2 bottom */
const T49 = t('t49', 'Classic Five Hero', 'hero', [
  s(5, 5, 90, 42),
  s(5, 52, 43, 43),
  s(52, 52, 43, 43),
]);

/* ── 50: CLASSIC GRID 2x3 (6) ───────────────────────────────
   Clean 2-row, 3-column grid */
const T50 = t('t50', 'Classic Grid 2x3', 'grid', [
  s(3, 5, 30, 42),
  s(35, 5, 30, 42),
  s(67, 5, 30, 42),
  s(3, 52, 30, 43),
...
/* ── 51: CLASSIC TALL DUO (2) ───────────────────────────────
   Two tall portrait columns */
const T51 = t('t51', 'Classic Tall Duo', 'duo', [
  s(15, 5, 32, 90),
  s(53, 5, 32, 90),
]);
...
const T52 = t('t52', 'Classic Row', 'strip', [
  s(5, 5, 90, 26),
  s(5, 37, 90, 26),
  s(5, 69, 90, 26),
]);

/* ── 53: CLASSIC WIDE HERO (4) ──────────────────────────────
   Wide hero top + three equal bottom row */
const T53 = t('t53', 'Classic Wide Hero', 'hero', [
  s(5, 5, 90, 45),
  s(5, 55, 28, 40),
  s(36, 55, 28, 40),
  s(67, 55, 28, 40),
...
/* ── 54: CLASSIC CROSS (5) ──────────────────────────────────
   Center hero + 4 corner accents */
const T54 = t('t54', 'Classic Cross', 'collage', [
  s(30, 30, 40, 40),
  s(5, 5, 22, 22),
  s(73, 5, 22, 22),
  s(5, 73, 22, 22),
...
export const TEMPLATE_COUNT = PAGE_TEMPLATES.length; // 54 templates total
