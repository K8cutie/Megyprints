/* Templates tab of the operator console — turn page layouts on/off or soft-delete
   them. Album generation only uses ACTIVE templates. (Extracted from the old
   stand-alone /admin page.) */
...
export default function TemplatesPanel() {
  ...
  return (
    <div>
      ...
      {!supabaseConfigured && (
        <p className="text-xs text-amber-600 mb-3">⚠ Supabase not configured — changes are local to this session only.</p>
      )}
