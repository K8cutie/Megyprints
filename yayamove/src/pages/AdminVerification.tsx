            ...
            return (
              <Card key={v.id} className="p-5">
                <div className="flex items-start gap-3">
                  <Avatar name={v.providerName} size="md" />
      ...
      <Modal
        ...
        title={
          <span className="flex items-center gap-2 text-brand-700">
            ...
            <span className="text-lg font-bold">NBI Clearance — {preview?.providerName}</span>
          </span>
        }
      >
        {preview && (
          <>
            ...
            <div className="mt-5 flex gap-2">
              <Button className="flex-1 bg-emerald-600 hover:bg-emerald-700" onClick={() => decide(preview, true)}>
                <ShieldCheck /> Approve &amp; verify
              </Button>
              <Button variant="outline" className="flex-1 text-destructive hover:bg-destructive/5" onClick={() => decide(preview, false)}>
                <ShieldX /> Reject
              </Button>
            </div>
          </>
